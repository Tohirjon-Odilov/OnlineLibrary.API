...
namespace UniversityProject.Infrastructure.Migrations
{
    ...
    [Migration("20241208091941_relationBookToUser")]
    partial class relationBookToUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UniversityProject.Domain.Entities.Book", b =>
                {
                    ...
                    b.Property<int?>("ApplcationUserId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("UniversityProject.Domain.Entities.Book", b =>
                {
                    b.HasOne("UniversityProject.Domain.Entities.Auth.ApplicationUser", "ApplicationUser")
                        .WithMany("Books")
